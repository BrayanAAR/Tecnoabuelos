...
fun EliminarAlarma(
    ...
    Scaffold(
        ...
        Column(
            ...
            Text(
                "3. Mantén presionado sobre la alarma que deseas eliminar. Se verá algo similar a esto: \n",
                fontSize = 22.sp
            )
            Image(
            ...
            Text(
                "4. En este paso puedes selecionar más alarmas que deseas eliminar\n",
                fontSize = 22.sp
            )
            Image(
            ...
            Spacer(modifier = Modifier.height(20.dp))
            Text(
                "5. Una vez seleccionada la(s) Alarma(s) deseada.Puedes presionar eliminar en la parte inferior de la pantalla\n",
                fontSize = 22.sp
            )
            Image(
            ...
            Spacer(modifier = Modifier.height(20.dp))
            Text("Y ya se habrán eliminado las alarmas \n", fontSize = 22.sp)
            Image(
