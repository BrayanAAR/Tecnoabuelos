...
fun DescargarFacebook(
    ...
    Scaffold(
        ...
        Column(
            ...
            Spacer(modifier = Modifier.height(20.dp))
            Text("3. Busca la lupa de la parte inferior con el nombre 'Buscar', presionala y escribe 'Facebook'.\n", fontSize = 22.sp)
            Image(
                painter = painterResource(id = R.drawable.ic_playstorefacebook1),
            ...
            Text(
                "4. Al buscar la aplicación, y seleccionar 'Facebook' entre las búsquedas, se muestra " +
            ...
            Image(
                painter = painterResource(id = R.drawable.ic_playstorefacebook2),
            ...
            Text(
                text = if (username.isNullOrEmpty())
                    "¡Felicitaciones por descargar Facebook!"
                else
                    "¡Felicitaciones $username por descargar Facebook!",
                fontSize = 22.sp
            )
