...
fun CrearCuentaInstagram(
    ...
    Column(
        ...
        Text("Cómo crear una cuenta de Instagram", style=headlineSmallStyle)
        Spacer(modifier = Modifier.height(20.dp))

        Text("1. Busca el ícono de Instagram en tu pantalla.\n", fontSize = 22.sp)
        ...
        Text("4. Puedes crear tu cuenta usando tu número de teléfono o tu correo. En este caso la haremos con el correo, pero los pasos son prácticamente los mismos, así que no te preocupes.\n", fontSize = 22.sp)
        Image(
        ...
        Text(
            "5. Una vez ingresado tu numero de telefono o correo, tendras que ingresar el codigo de verificacion que te llegara\n",
            fontSize = 22.sp
        )
        Image(
        ...
        Text(
            "7. Te pedira que ingreses tu fecha de nacimiento para corroborar que eres mayor de edad" +
        ...
        Text(
            "8. Ingresa el nombre de usuario por el cual las demas personas te encontraran dentro de la aplicacion.\n",
            fontSize = 22.sp
        )
        Image(
        ...
        Text(
            "9. Acepta las condiciones y politicas de Instagram.\n",
            fontSize = 22.sp
        )
        Image(
