    ...
    Scaffold(
        topBar = {
            CenterAlignedTopAppBar(
                title = {
                    Text("¿Cómo se descarga Instagram?", style = headlineSmallStyle, textAlign = TextAlign.Center)
                },
                navigationIcon = {
        ...
        Column(
            ...
            Spacer(modifier = Modifier.height(20.dp))
            Text("3. Busca la lupa de la parte inferior con el nombre 'Buscar', presionala y escribe 'Instagram'.\n", fontSize = 22.sp)
            Image(
            ...
            Text(
                "4. Al buscar la aplicación, y seleccionar 'Instagram' entre las búsquedas, se muestra " +
