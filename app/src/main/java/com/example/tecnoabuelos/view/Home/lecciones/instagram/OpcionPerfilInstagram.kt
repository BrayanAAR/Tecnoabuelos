    ...
    Scaffold(
        topBar = {
            CenterAlignedTopAppBar(
                title = {
                    Text("Opciones de Perfil", style = headlineSmallStyle, textAlign = TextAlign.Center)
                },
                navigationIcon = {
        ...
        Column(
            ...
            Text(
                text = if (username.isNullOrEmpty())
                    ...
                    "¡Muy bien $username! Ya conoces todas las opciones básicas del perfil de Instagram.",
                fontSize = 22.sp
            )
