    ...
    Scaffold(
        topBar = {
            CenterAlignedTopAppBar(
                title = {
                    Text("¿Cómo se descarga Tiktok?", style = headlineSmallStyle)
                },
                navigationIcon = {
        ...
        Column(
            ...
            Spacer(modifier = Modifier.height(20.dp))
            Text("3. Busca la lupa de la parte inferior con el nombre 'Buscar', presionala y escribe 'Tiktok'.\n", fontSize = 22.sp)
            Image(
            ...
            Text(
                "4. Al buscar la aplicación, y seleccionar 'Tiktok' entre las búsquedas, se muestra " +
