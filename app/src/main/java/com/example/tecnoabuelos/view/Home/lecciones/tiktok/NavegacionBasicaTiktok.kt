    ...
    Scaffold(
        topBar = {
            CenterAlignedTopAppBar(
                title = {
                    Text("Conoce más de Tiktok", style = headlineSmallStyle)
                },
                navigationIcon = {
        ...
        Column(
            ...
            Text("1. Busca el ícono de la aplicacion en el teléfono.\n", fontSize = 22.sp)
            //ic_tiktok0
            Image(
            ...
            Text(
                "2. Una vez abierto te pedirá aceptar los terminos y condiciones, le daremos en 'Aceptar y continuar' .\n",
                fontSize = 22.sp
            )
            Image(
            ...
            Text(
                "3. Ahora te preguntará si quieres recibir notificaciones de la aplicación, tambien le daremos los permisos.\n",
                fontSize = 22.sp
            )
            Image(
            ...
            Text(
                "4. Tiktok quiere saber un poco más de ti, por eso te pedirá que tipo de contenido quieres ver, puedes seleccionar todos los que quieras.\n",
                fontSize = 22.sp
            )
            Image(
            ...
            Text(
                "5. Y con eso ya estas listo para usar Tiktok y ver todo lo que te guste.\n",
                fontSize = 22.sp
            )
            Image(
            ...
            Text(
                text =
                    if (username.isNullOrEmpty())
                        "¡Excelente! Ya sabes navegar por Tiktok.¡Felicidades!"
                    else
                        "¡Muy bien $username! Ya configuraste Tiktok.¡Felicidades!",
                fontSize = 22.sp
            )
            ...
            Text(
                "Busca el ícono de la casita en la esquina inferior de la pantalla.\n",
                fontSize = 22.sp
            )
            Text("aqui veras las ultimas publicaciones sugeridas para ti.\n", fontSize = 22.sp)
            ...
            Text(
                "El icono de las dos personas juntas te muestra los videos de amigos o de la gente que sigues .\n",
                fontSize = 22.sp
            )
            Image(
            ...
            Text(
                " En el + que se encuentra en la parte del medio inferior de la pantalla, podras crear un video de tiktok, ¿Puede ser que seas la nueva imagén de Tiktok? .\n",
                fontSize = 22.sp
            )
            ...
            Text(
                "En el icono de los mensajes podrás ver tus conversaciones con otros usuarios.\n",
                fontSize = 22.sp
            )
            Image(
            ...
            Text(
                text =
                    if (username.isNullOrEmpty())
                        ...
                        "¡Muy bien $username! Ya sabes navegar por Tiktok.¡Felicidades!",
                fontSize = 22.sp
            )
