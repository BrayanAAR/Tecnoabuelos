    ...
    Scaffold(
        topBar = {
            CenterAlignedTopAppBar(
                title = {
                    Text(
                        "¿Cómo se cambia el tamaño de la letra?",
        ...
        Column(
            ...
            Spacer(modifier = Modifier.height(20.dp))
            Text(
                "3. Busca los tres puntitos de la parte superior. Al presionarlos aparecerá un menu como este:\n",
                fontSize = 22.sp
            )
            Image(
            ...
            Text("5. Selecciona la opción que dice 'Chats'.\n", fontSize = 22.sp)
            Image(
            ...
            Text("6. Selecciona la opción 'Tamaño de fuente'. \n", fontSize = 22.sp)
            Image(
            ...
            Spacer(modifier = Modifier.height(20.dp))
            Text("7. Elige el tamaño que más te acomode y presiona 'Ok'. \n", fontSize = 22.sp)
            Image(
