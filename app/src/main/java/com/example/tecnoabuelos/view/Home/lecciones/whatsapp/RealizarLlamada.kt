    ...
    Scaffold(
        topBar = {
            CenterAlignedTopAppBar(
                title = {
                    Text(
                        "¿Cómo se realiza una llamada en WhatsApp?",
        ...
        Column(
            ...
            Spacer(modifier = Modifier.height(20.dp))
            Text("3. Busca y selecciona el chat que deseas llamar.\n", fontSize = 22.sp)
            Image(
            ...
            Text(
                "4. Presiona el icono de telefono en la parte superior, como se indica en la siguiente imagen.\n\n",
                fontSize = 22.sp
            )
            Image(
            ...
            Text(
                "5. ¡Ya estas marcando! Solo queda esperar que la otra persona consteste \n",
                fontSize = 22.sp
            )
            Image(
